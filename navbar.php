...
<div class="container-fluid">
  <img class="mb-2" src="img/logo.png" alt="" width="35" height="25">
  ...
  <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
    <div class="navbar-nav">
      ...
      switch ($uri_current) {
        ...
        if ($_SESSION['user']){
          echo '<a class="nav-link" aria-current="page" href="profile.php">Профиль</a>';
          echo '<a class="nav-link" aria-current="page" href="logout.php">Выход</a>';
        }
      ?>
    </div>
  </div>
...
<div class="container px-4 px-lg-5 my-5">
    <div class="text-center text-white">
        <h1 class="display-4 fw-bolder">Yourtickets</h1>
